...
// ============================================================================
// BigModal - Large card for community/group display
// ============================================================================
...
// ============================================================================
// MediumModal - Medium card for conversation list items
// ============================================================================
...
// ============================================================================
// CallOnHomepage - Small avatar display for call participants
// ============================================================================

export interface CallOnHomepageProps {
  display: string;
  avatar?: string;
}
...
// ============================================================================
// Profile - Small profile card (used in hover cards, etc.)
// ============================================================================
...
// ============================================================================
// BigProfile - Full page profile view
// ============================================================================

export interface BigProfileProps {
  creationTimestamp: UnixTimestamp;
  title: string;
  description: string;
  status?: string;
...
// ============================================================================
// SmallModal - Compact card for list items
// ============================================================================
...
export function SmallModal({
  ...
  return loading ? (
    <div className="w-full bg-input/30 p-2 rounded-xl border-input flex gap-2 items-center border">
    ...
    <div
      role="button"
      tabIndex={0}
      className={`w-full p-2 rounded-xl flex gap-2 items-center border cursor-pointer transition-all duration-200 ${
        active
    ...
    >
      <Avatar
        ...
        loading={false}
      />
      <p className="text-sm font-medium select-none">{title}</p>
    </div>
  );
}
