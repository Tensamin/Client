...
export function useScreenShareAudio(): UseScreenShareAudioReturn {
  ...
  const startScreenShareWithAudio = useCallback(
    async (
      ...
      try {
        ...
        rawDebugLog("ScreenShareAudio", "Video track published", undefined, "green");
  ...
  const stopScreenShare = useCallback(async () => {
    ...
    try {
      ...
      rawDebugLog("ScreenShareAudio", "Screen share stopped", undefined, "purple");
    } catch (error) {
  ...
  // Track when screen share is disabled externally
  useEffect(() => {
